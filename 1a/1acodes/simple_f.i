s0 = -1.25e6 #gamma*g*h #h=100m #gamma = 2500 (given) #g =10
K = 0.25 #the ratio of horizontal and vertical stress #sigma_h/sigma_v
...
[Materials]
  ...
  [ini_stress]
    ...
    block = domain
    initial_stress = '-0.3125e6 ${s0} 0 0 -0.3125e6 0 0 0 0'
